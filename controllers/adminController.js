  ...
  client.query(query, (err, result) => {
    ...
    for (let i = 0; i <= n; i++) {
      for (let j = 0; j <= 4; j++) {
        ...
        console.log(id);
        // console.log(req.body["f1_pref1cb"]);
        if (req.body[id] == 'on')
          selectedPrefs[i][j] = 1;
        else
          selectedPrefs[i][j] = 0;
